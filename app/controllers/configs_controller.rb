class ConfigsController < ApplicationController
  ...
  private
    ...
    def config_params
      params.require(:config).permit(:is_support_employee, :prefix_contry, :is_vote_supported, :is_menu_service_showed, :default_trank_context, :is_trank_context_showed, :password, :is_outgoing_deleted, :is_outgoing_table_showed, :is_google_integrated, :is_attempt_supported, :is_answer_supported)
    end
