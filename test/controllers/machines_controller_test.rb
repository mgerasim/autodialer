...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { amdcause: @machine.amdcause, amdstatus: @machine.amdstatus, telephone: @machine.telephone } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { amdcause: @machine.amdcause, amdstatus: @machine.amdstatus, telephone: @machine.telephone } }
